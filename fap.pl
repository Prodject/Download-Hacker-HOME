...
print "\t>#------------------------------------------------------------------------------------------------#\n";
print "\t>#                                                                                                #\n";
print "\t>#                                FIND CONTROL PANEL OF WEBSITE                                   #\n";
print "\t>#                                                                                                #\n";   
print "\t>#  .oOo                o                   o                                                     #\n";
print "\t>#  O    o             O                   O           o                                          #\n";
print "\t>#  o                  o                   o                                                      #\n";
...
print "\t>#  Find|Admin|Page|V1.0|                      #  | {we Are Don't Forget}        }                #\n";
print "\t>#                                             #  | {expect us}                  }                #\n";
print "\t>#------------------------------------------------------------------------------------------------#\n";
...
@path1=('adm/','admmi/','admins','adminn','admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
@path2=('adm/','admmi/','admins/','adminn/','add/','admiin/','usr/','usrlog/','usrname/','loginpass/','adminCP/','admincp/','adminpc/','adminPC/','adminlog/','usernames/','usrlogin/','adcp/','adim/','a/','uscp/','usad/','admr/','amd/','joker/','world/','life/','adminman/','adminusr/','admind/','adminsterator/','adminjack/','adminahmad/','adminmohmmad/','adminmark/','adminali/','admintarq/','adminoseid/','adminhhack/','admonsecurity/','adminsecu','
adm/','admmi/','admins','adminn','admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
@path2=('adm/','admmi/','admins','adminn','admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','admin6/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
