...
print RED+"                        _   _ _     _                                           "      
print RED+"                       | | | (_)   | |                                          "        
print RED+" __      _____  _ __ __| | | |_ ___| |_    __ _  ___ _ __                       "  
print RED+" \ \ /\ / / _ \| '__/ _` | | | / __| __|  / _` |/ _ \ '_ \                      " 
print RED+"  \ V  V / (_) | | | (_| | | | \__ \ |_  | (_| |  __/ | | |                     "
print RED+"   \_/\_/ \___/|_|  \__,_| |_|_|___/\__|  \__, |\___|_| |_|                     "
print RED+"                                           __/ |                                "
print RED+"                                           |___/                                " 
print BLUE+"         by: Oseid Aldary                                                      " 
print GREEN+"                                                                              "
print GREEN+"                                                                              "
print GREEN+"                                                                              "           
print GREEN+"                                                                              "                              
...
print ""
print ""
print BUS+"[*] [Enter target info]:"+WHITE+" to make a word list for you :)\n"
...
# --------------------------------
surname = raw_input(GREEN+">>"+RED+" Enter Target Surname:> ")
print ""
nick = raw_input(RED+">>"+BLUE+" Enter Target Nickname:> ")
print ""
birthdate = raw_input(BLUE+">>"+GREEN+" Enter target Birthdate:> ")
print ""
print "-----------------------------------------------------------"
wife = raw_input(GREEN+">>"+RED+" Wife's(husband's) name:> ")
print ""
wifen = raw_input(RED+">>"+BLUE+" Wife's(husband's) nickname:> ")
print ""
wifeb = raw_input(BLUE+">>"+RED+" Wife's(husband's) birthdate :> ")
print ""
print "-----------------------------------------------------------"
kid = raw_input(RED+">>"+GREEN+" Child's name :> ")
print ""
kidn = raw_input(GREEN+">>"+RED+" Child's nickname :> ")
print ""
kidb = raw_input(RED+">>"+BLUE+" Child's birthdate :> ")
print ""
pet = raw_input(BLUE+">>"+RED+" Pet's name:> ")
print ""
company = raw_input(RED+">>"+GREEN+" Company name:> ")

print ""
words = ['']
oth = raw_input("> Do you want to add some key words about the victim? [Y/N]: ")
if oth == "y" or oth == "Y":
	words = raw_input("> Please enter the words, separated by comma. [i.e. hacker, security, Oseid]: ").split(", ")

print "----------------------------------------------------------------------------"
print ""
name = raw_input(RED+">>"+GREEN+" Enter Name for save wordlist file:> ")
print ""
...
print BUS+"[*]"+WHITE+" Saving dictionary to "+GREEN+"[DHH/"+name+".txt]"+WHITE+", counting "+GREEN+"["+str(lines)+"]"+WHITE+" words."
